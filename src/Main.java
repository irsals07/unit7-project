        ...
        while (on){
            ...
            if(c == 1){
                ...
                System.out.println("1) base cost is $3.75\n" +
                        "2) add 5 cents per 10th of a pound\n" +
                        "3) divide difference of country codes by 100 and add that to the total\n" +
                        "* If over 36inches in length + height + width or above 40lbs\n" +
                        "1) add 10 cents per additional inch\n" +
                        "2) add 10 cents per additional pound");
            }
            else if(c == 4){
                on = false;
            }
